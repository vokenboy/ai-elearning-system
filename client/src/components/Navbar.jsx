...
const Navbar = () => {
    ...
    const showCourses = authenticated;
    const showEditCourses =
        authenticated && ["Admin", "Editor"].includes(userRole);

    return (
        <div className="navbar bg-base-200 fixed top-0 z-50 shadow-lg px-4">
