...
def generate_exam_questions(task_request: TaskRequest):
    ...
    response = client.models.generate_content(
        ...
        config=GenerateContentConfig(
            ...
            "Answers to the questions can be single select, true/false question, multiple select.",
            "Based on question type generate possible answers for the question.",
            "For single select and true/false questions generate one correct and other incorrect answers.",
