      ...
      >
        ...
        >
          ...
          <Box component="ul" sx={{ pl: 2 }}>
            <li>
              <Typography variant="body1">The function should take an array of numbers as input</Typography>
            </li>
            <li>
              <Typography variant="body1">Return the sum of all elements in the array</Typography>
            </li>
            <li>
              <Typography variant="body1">If the array is empty, return 0</Typography>
            </li>
          </Box>
...
Output: 0`}
        ...
        {/* Code Editor and Feedback Panel */}
        <Box
          sx={{
            width: { xs: "100%", md: "60%" },
            display: "flex",
        ...
        >
          ...
          <Box sx={{ p: 2, borderTop: 1, borderColor: "divider", display: "flex", justifyContent: "flex-end" }}>
            <Button variant="contained" color="primary" onClick={handleSubmitCode} disabled={isSubmitting} size="large">
